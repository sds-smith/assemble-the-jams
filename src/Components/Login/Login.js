...
class Login extends React.Component {
    ...
    render() {
        return (
            <div className='Login'>
                <h2>This app is registered in Development mode with Spotify. In order to use the app, you must be explicitly added as a user.</h2>
                <h3>You only need to request access once, but there may be a delay between requesting and gaining access</h3>
                <h3>For more information on this app, please see the About page</h3>
