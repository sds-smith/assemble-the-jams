    ...
    render() {
        return (
            <div className='Login'>
                ...
                <h3 className='loginMessage'>For more information on this app, please see the <a id='readme' href='https://github.com/sds-smith/assemble-the-jams#readme' target='_blank'>README</a></h3>
